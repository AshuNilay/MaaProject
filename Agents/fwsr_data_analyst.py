...
from Agents import DataWranglingAgent, DataVisualizationAgent
from utils.plotly import plotly_from_dict
from utils.regex import remove_consecutive_duplicates, get_generic_summary

AGENT_NAME = "fwsr_data_analyst"
